                ...
                for (auto& pushConstant : reflection.pushConstants)
                {
                    for (auto& member : pushConstant.members)
                    {
                        ...
                        switch (member.type)
                        {
                            ...
                            case ShaderDataType::INT:		glUniform1iv(location, 1, (int32_t*)data);					break;
                            case ShaderDataType::INT2:		glUniform2iv(location, 1, (int32_t*)data);					break;
                            case ShaderDataType::INT3:		glUniform3iv(location, 1, (int32_t*)data);					break;
                            case ShaderDataType::INT4:		glUniform4iv(location, 1, (int32_t*)data);					break;
                            case ShaderDataType::UINT:		glUniform1uiv(location, 1, (uint32_t*)data);				break;
                            case ShaderDataType::UINT2:		glUniform2uiv(location, 1, (uint32_t*)data);				break;
                            case ShaderDataType::UINT3:		glUniform3uiv(location, 1, (uint32_t*)data);				break;
                            case ShaderDataType::UINT4:		glUniform4uiv(location, 1, (uint32_t*)data);				break;
