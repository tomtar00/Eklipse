...
namespace Eklipse
{
    namespace OpenGL
    {
        ...
        void OpenGLAPI::Draw(Ref<VertexArray> vertexArray)
        {
            EK_CORE_PROFILE();

            glDrawArrays(g_currentTopologyMode, 0, vertexArray->GetTotalNumVertices());
        }
        ...
        {	
            ...
            glDrawElements(g_currentTopologyMode, numIndices, GL_UNSIGNED_INT, nullptr);
        }
    }
}